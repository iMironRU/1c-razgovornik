...
- **Онлайн** — `https://imironru.github.io/1c-razgovornik` _(после включения GitHub Pages)._
...
|---|---|---|
| 0. Предисловие | Для кого книга, как читать, что считаем общим знанием | review |
| 1. Природа языка | Парадигма, типизация, типы модулей, контекст выполнения | review |
| 2. Переменные и примитивные типы | Объявление, область видимости, строка, число, дата | review |
| 3. Коллекции | Массив, структура, соответствие, таблица и дерево значений | review |
| 4. Управление потоком | `Если`, тернарный `?()`, три цикла, `Прервать` / `Перейти` | review |
